...
┌─────────────────┐ ┌──────────────────┐ ┌─────────────────┐ │ Angular 18 │ │ .NET 8 API │ │ AWS Services │ │ Frontend │◄───┤ (App Runner) │◄───┤ (S3, ECR) │ │ │ │ │ │ │ │ - SignalR │ │ - CQRS/MediatR │ │ - CloudWatch │ │ - JWT Auth │ │ - JWT Security │ │ - Systems Mgr │ │ - Real-time UI │ │ - SignalR Hub │ │ - Document S3 │ └─────────────────┘ └──────────────────┘ └─────────────────┘
